...
public sealed partial class RoleBanListCommand : LocalizedCommands
{
    ...
    public override async void Execute(IConsoleShell shell, string argStr, string[] args)
    {
        ...
        if (shell.Player is not { } player)
        {
            ...
            {
                var msg = Loc.GetString("cmd-rolebanlist-ban", ("id", ban.Id), ("role", string.Join(",", ban.Roles ?? [])), ("reason", ban.Reason));
                shell.WriteLine(msg);
            }
