...
public sealed partial class RatvarianLanguageSystem : RelayAccentSystem<RatvarianLanguageComponent>
{
    public static readonly EntProtoId Ratvarian = "StatusEffectRatvarianLanguage";

    [Dependency] private StatusEffectsSystem _statusEffect = default!;

    protected override Type[] AccentBefore => [typeof(SlurredSystem), typeof(StutteringSystem)];
    protected override Type[] RelayAccentBefore => [typeof(SlurredSystem), typeof(StutteringSystem)];
